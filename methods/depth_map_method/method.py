...
def main():
    ...
    read_dir_name_sane=os.path.join(data_folder;r'multi_focus\depth_map\clean')
    read_dir_name_contaminated=os.path.join(data_folder,r'multi_focus\depth_map\contaminated')
    read_dir_manual_segmentation=os.path.join(data_folder,r'multi_focus\ground_truth')
    write_dir_name_sane=os.path.join(results_folder,r'depth_map_method\cropped_ground_truth')
    write_dir_name_contaminated=os.path.join(results_folder,r'depth_map_method\automatic_segmentation')
    write_dir_name_difference_brute=os.path.join(results_folder,r'depth_map_method\raw_difference')
    write_dir_name_difference_ouverte=os.path.join(results_folder,r'depth_map_method\intermediate_difference')
