...
def main():
    ...
    read_dir_name_sane=os.path.join(data_folder,r'multi_focus\focused_single_slice\clean')
    read_dir_name_contaminated=os.path.join(data_folder,r'multi_focus\focused_single_slice\contaminated')
    read_dir_manual_segmentation=os.path.join(data_folder,r'multi_focus\ground_truth')
    write_dir_name_sane=os.path.join(results_folder,r'compound_sharp_method\cropped_ground_truth')
    write_dir_name_contaminated=os.path.join(results_folder,r'compound_sharp_method\automatic_segmentation')
    write_dir_name_difference_brute=os.path.join(results_folder,r'compound_sharp_method\raw_difference')
    write_dir_name_difference_ouverte=os.path.join(results_folder,r'compound_sharp_method\intermediate_difference')
