...
predicted_mask_dir = r"C:\Users\PILLLARD-DOR\Documents\TEMPO\results_and_intermediate\SAM_method\SAM_cutouts"

#Binary cutout saves
save_dir=r"C:\Users\PILLLARD-DOR\Documents\TEMPO\results_and_intermediate\SAM_method\binary_cutouts"
...
for filename in filenames:
    ...
    pred_img=skimage.transform.resize(pred_img,gt_img.shape)
...
print(df)
df.to_csv(r"C:\Users\PILLLARD-DOR\Documents\TEMPO\results_and_intermediate\SAM_method\results.csv",index=True)