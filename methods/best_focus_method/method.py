...
def main():
    ...
    # Write directories
    automatic_segmentation_folder_alternate_filters=os.path.join(results_folder,r"best_focus_method\automatic_segmentation\alternate_filters\masks")
    intermediate_difference_folder_alternate_filters=os.path.join(results_folder,r'best_focus_method\automatic_segmentation\alternate_filters\intermediate_difference')
    automatic_segmentation_folder_h_maximas=os.path.join(results_folder,r'best_focus_method\automatic_segmentation\h_maximas\masks')
    gaussian_filtered_image_folder=os.path.join(results_folder,r'best_focus_method\automatic_segmentation\h_maximas\filtered_difference')
    intermediate_difference_folder_h_maximas=os.path.join(results_folder,r'best_focus_method\automatic_segmentation\h_maximas\intermediate_difference')
    automatic_segmentation_folder_reconstruction=os.path.join(results_folder,r'best_focus_method\automatic_segmentation\reconstruction\masks')
    intermediate_difference_folder_reconstruction=os.path.join(results_folder,r'best_focus_method\automatic_segmentation\reconstruction\intermediate_difference')
    reconstruction_folder=os.path.join(results_folder,r'best_focus_method\reconstructed_image')
    full_reconstruction_folder=os.path.join(results_folder,r'best_focus_method\full_reconstruction')
...
#- essayer avec les maximas
        ...
        if h_maximas>0:
            # Vérifier que les h_maximas de scikit sont bien définis de la même façon que dans la morpho maths
            # Faire la reconstruction géodésique de f-h sous f 
